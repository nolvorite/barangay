...
<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h3 class="mt-4">Vaccinated</h3>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Vaccinated</li>
                        </ol>
                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="">
                                            <a type="button" href="<?php echo URLROOT. '/residents/generate_vaccinated' ?>" id="addResidentBtn" class="btn btn-primary btn-sm">
                                ...
                                <div class="card-body ">
                                    ...
                                    <table id="datatablesSimple">
                                        ...
                                        <tbody>
                                        <?php foreach ($data['vaccinated'] as $resident):?>
                                            <tr>
