...
<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h3 class="mt-4">Senior Citizen</h3>
                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="">
                                            <a type="button" href="<?php echo URLROOT. '/residents/generate_senior' ?>" id="addResidentBtn" class="btn btn-primary btn-sm">
                                ...
                                <div class="card-body ">
                                    ...
                                    <table id="datatablesSimple">
                                        ...
                                        <tbody>
                                        <?php foreach ($data['seniorCitizen'] as $resident):?>
                                            <tr>
