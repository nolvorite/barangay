                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="">
                                            <a type="button" href="<?php echo URLROOT. '/residents/generate_voter' ?>" id="addResidentBtn" class="btn btn-primary btn-sm">
                                ...
                                <div class="card-body ">
                                    ...
                                    <table id="datatablesSimple">
                                        ...
                                        <tbody>
                                        <?php foreach ($data['voters'] as $resident):?>
                                            <tr>
