...
<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                            <h3 class="mt-4">Generate Person with Disablity</h3>
                                <ol class="breadcrumb mb-4">
                                    <li class="breadcrumb-item active">Generate Person with Disablity</li>
                                </ol>
                                            ...
                                            <div class="card mb-4">
                                                ...
                                                <div class="card-body m-5" id="printThis">
                                                    ...
                                                    <table class="table caption-top mt-2">
                                                        <caption><h6>List of Person with Disablity</h6></caption>
                                                        <caption>Total: <?php echo $data['totalPwd'] ?></caption>
                                                        <thead>
                                                            <tr>
                                                                <th>Household No.</th>
                                                                <th>Name</th>
