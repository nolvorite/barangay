...
<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                            <h3 class="mt-4">Generate Covid Positive</h3>
                                <ol class="breadcrumb mb-4">
                                    <li class="breadcrumb-item active">Generate Covid Positive</li>
                                </ol>
                                                ...
                                                <div class="card-body m-5" id="printThis">
                                                    <div class="d-flex flex-wrap justify-content-around">
                                                        ...
                                                        <div id="cert-head" class="text-center mt-5">
                                                            ...
                                                            <h3 class="mb-0">Municipality of BOLINAO</h3>
                                                            <h1 class="fw-bold mb-0">Barangay Lucero</i></h2>
                                                        </div>
                                                        <div class="text-center">
                                                    ...
                                                    <table class="table caption-top mt-2">
                                                        <caption><h6>List of Covid Positive</h6></caption>
                                                        <caption>Total: <?php echo $data['totalCovid'] ?></caption>
                                                        <thead>
                                                            <tr>
                                                                <th>Household No.</th>
                                                                <th>Name</th>
