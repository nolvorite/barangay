                                                        ...
                                                        <div class="col-9">
                                                            <div id="cert-body" class="col-md-12">
                                                                ...
                                                                <div class="text-center mt-4">
                                                                    <h1 id="brgy-cert-h1" class="mb-5">CERTIFICATE OF RESIDENCY</h1>
                                                                </div>
                                                                ...
                                                                is a resident with postal address at <span><?php echo $data['certificate']->postal_address ?> </span>, Barangay Pinyahan, Quezon City since <?= $data['certificate']->resident_since ?> up to the present.</h2>
                                                                <h2>This Certification is being issued upon the request of <span><?= strtoupper( $data['certificate']->first_name.' '.$data['certificate']->middle_name.' '.$data['certificate']->last_name) ?></span> for <span><?= $data['certificate']->purpose ?></span> purpose only.</h2>
