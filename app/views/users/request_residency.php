...
<section id="header" class="d-flex flex-column justify-content-center">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-8">
          <h1 class = "animated fadeInUp" style = "animation-delay: 0.3s">Certificate of Residency</h1>
            ...
            <div class="card mb-2 col-12 offset-md-3 col-md-6 mt-3 mb-5">
                <div class="card-header">
                    <div class="row">
                        ...
                        <h4 class="mx-auto text-center">Certificate of Residency</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body ">
                    <form action="<?php echo URLROOT; ?>/users/request_residency" method="POST">
                        <div class="row g-2 pb-3">
                            ...
                            <div class="col-6 col-md-6 ">
                                <label for="postalAddress" class="col-form-label-sm">Postal Address</label>
                                <input type="text" name="postalAddress" value="<?php echo $data['postal_address'] ?>" class="form-control" id="postalAddress">
                                <div class="validation-invalid"><?php echo $data['postal_addressError'] ?></div>
                            </div>
                            <div class="col-6 col-md-6">
                                <label for="inputResidentSince"  class="col-form-label-sm">Resident Since (Year)</label>
                                <input type="text" name="residentSince" value="<?php echo $data['resident_since'] ?>" placeholder="2020" class="form-control" id="inputResidentSince">
                                <div class="validation-invalid"><?php echo $data['resident_sinceError'] ?></div>
                            </div>
                            <div class="col-6 col-md-6 ">
