...
<section id="header" class="d-flex flex-column justify-content-center">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-8">
          <h1 class = "animated fadeInUp" style = "animation-delay: 0.3s">Barangay Clearance</h1>
                ...
                <div class="card-body ">
                    <form action="<?php echo URLROOT; ?>/users/request_clearance" method="POST">
                        <div class="row g-2 pb-3">
                            ...
                            <div class="col-6 col-md-6 ">
                                <label for="taxCertNo" class="col-form-label-sm">Community Tax Certificate No.</label>
                                <input type="text" name="taxCertNo" value="<?php echo $data['tax_cert_no'] ?>" class="form-control" id="taxCertNo">
                                <div class="validation-invalid"><?php echo $data['tax_cert_noError'] ?></div>
                            </div>
                            <div class="col-6 col-md-6 ">
